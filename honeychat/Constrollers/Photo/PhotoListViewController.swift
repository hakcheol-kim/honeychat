...
class PhotoListViewController: BaseViewController {
    ...
    override func viewDidLoad() {
        ...
        segSort.layer.borderColor = UIColor.appColor(.appColor).cgColor
        segGender.layer.borderWidth = 1;
        segGender.layer.borderColor = UIColor.appColor(.appColor).cgColor
        
        segSort.setTitleTextAttributes([NSAttributedString.Key.foregroundColor : UIColor.appColor(.appColor)], for: .normal)
        segSort.setTitleTextAttributes([NSAttributedString.Key.foregroundColor : UIColor.white], for: .selected)
        
        segGender.setTitleTextAttributes([NSAttributedString.Key.foregroundColor : UIColor.appColor(.appColor)], for: .normal)
