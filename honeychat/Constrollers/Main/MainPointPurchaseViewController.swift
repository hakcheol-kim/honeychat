...
class MainPointPurchaseViewController: BaseViewController {
...
//                param["developerPayload"] = payload //서버에서 생성한 payload sequence
    ...
    func logoPurchaseEvent(_ param: [String : Any]) {
        ...
        AppsFlyerEvent.addEventLog(.inapp, [
            ...
            AFEventParam2: (param["packageName"] ?? "")
        ])
    }
...
//                self.refreshUi()
    ...
    @IBAction func onClickedBtnActions(_ sender: UIButton) {
        if sender == btnContactus {
            ...
            switch sender.tag {
            case 0:
                self.requestPayloadId(.point_00)
                break
            case 1:
                self.requestPayloadId(.point_01)
                break
            case 2:
                self.requestPayloadId(.point_02)
                break
            case 3:
                self.requestPayloadId(.point_03)
                break
            case 4:
                self.requestPayloadId(.point_04)
                break
            case 5:
                self.requestPayloadId(.point_05)
                break
            default:
                break
            }
            ...
            switch sender.tag {
                case 0:
                    print("구독 1")
                    self.requestPayloadId(.subscribe_0)
                    break
                case 1:
                    print("구독 2")
                    self.requestPayloadId(.subscribe_1)
                    break
                case 2:
                    print("구독 3")
                    self.requestPayloadId(.subscribe_2)
                    break
                case 3:
                    print("구독 4")
                    self.requestPayloadId(.subscribe_3)
                    break
                default:
                    break
            }
