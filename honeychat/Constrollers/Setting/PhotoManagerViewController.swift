...
class PhotoManagerViewController: BaseViewController {
    ...
    func showPhotoUsingAlert(_ orig:UIImage, _ crop: UIImage) {
        ...
        DispatchQueue.main.asyncAfter(deadline: DispatchTime.now()+0.2) { [weak self] in
            ...
            vc.addAction(.check, NSLocalizedString("layout_txt91", comment: "프로필 이미지에 등록"), nil, .appColor(.appColor), true)
            vc.addAction(.check, NSLocalizedString("layout_txt92", comment: "영상톡 이미지에 등록"), nil, .appColor(.appColor), true)
            vc.addAction(.check, NSLocalizedString("layout_txt93", comment: "일반톡 이미지에 등록"), nil, .appColor(.appColor), true)
...
extension PhotoManagerViewController: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        if view_yn == "Y" {
            ...
            cell.btnState.setTitleColor(UIColor.appColor(.appColor), for: .normal)
        }
        else {
            cell.btnState.setTitle(NSLocalizedString("layout_txt89", comment: "검증중"), for: .normal)
            cell.btnState.setTitleColor(UIColor.appColor(.yellow), for: .normal)
        }
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        if view_yn == "N" {
            ...
            vc.addAction(.check, NSLocalizedString("layout_txt99", comment: "포토톡 사진 추가 등록"), nil, .appColor(.appColor), true)
            ...
            if type == .cam {
                vc.addAction(.check, NSLocalizedString("layout_txt96", comment: "프로필 사진 변경 등록"), nil, .appColor(.appColor), false)
                vc.addAction(.check, NSLocalizedString("layout_txt97", comment: "영상톡 사진 변경 등록"), nil, .appColor(.appColor), true)
                vc.addAction(.check, NSLocalizedString("layout_txt98", comment: "일반톡 사진 변경 등록"), nil, .appColor(.appColor), false)
            }
            else if type == .talk {
                vc.addAction(.check, NSLocalizedString("layout_txt96", comment: "프로필 사진 변경 등록"), nil, .appColor(.appColor), false)
                vc.addAction(.check, NSLocalizedString("layout_txt97", comment: "영상톡 사진 변경 등록"), nil, .appColor(.appColor), false)
                vc.addAction(.check, NSLocalizedString("layout_txt98", comment: "일반톡 사진 변경 등록"), nil, .appColor(.appColor), true)
            }
            else if type == .profile {
                vc.addAction(.check, NSLocalizedString("layout_txt96", comment: "프로필 사진 변경 등록"), nil, .appColor(.appColor), true)
                vc.addAction(.check, NSLocalizedString("layout_txt97", comment: "영상톡 사진 변경 등록"), nil, .appColor(.appColor), false)
                vc.addAction(.check, NSLocalizedString("layout_txt98", comment: "일반톡 사진 변경 등록"), nil, .appColor(.appColor), false)
            }
            else {
